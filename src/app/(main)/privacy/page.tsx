  ...
  return (
    <MaxWidthWrapper className="py-16 md:py-24">
      <div className="prose prose-lg max-w-none">
        <h1>Privacy Policy for Papermind AI</h1>
        ...
        <p>We do not sell your personal information. We may share the information we collect in the following circumstances:</p>
        <ul>
        ...
        <p>We specifically use the following key third-party services:</p>
        <ul>
